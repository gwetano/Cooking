...
<body>
    ...
    <main id="main-content">
        <form id="loginForm">
            ...
            <p>
                <input type="checkbox" name="ricordami" class="checkbox"> Ricordami
            </p>
            <p>
        ...
        document.getElementById('registratiCliccabile').addEventListener('click', function() {
            document.getElementById('main-content').innerHTML = `
                <form id="registerForm">
                    ...
                    <input type="text" name="usernameRegistrazione" placeholder="Username" required><br>
                    <input type="password" name="passwordRegistrazione" placeholder="Password" required><br>
                    <input type="password" name="repassword" placeholder="Ripeti Password" required><br>
                    <p>
